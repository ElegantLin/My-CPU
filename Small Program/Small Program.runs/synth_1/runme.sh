...
HD_PWD='D:/Computer Architecture/My-CPU/Small Program/Small Program.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Small_Program_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Small_Program_Top.tcl
