...
HD_PWD='D:/Computer Architecture/My-CPU/Small Program/Small Program.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Small_Program_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Small_Program_Top.tcl -notrace
